...
//-------------------------------------------------------------------------
// - ButtonBehavior() [MakeInternal]
// - Button()
// - SmallButton()
// - InvisibleButton()
// - ArrowButton()
// - CloseButton() [MakeInternal]
// - CollapseButton() [MakeInternal]
// - GetWindowScrollbarID() [MakeInternal]
// - GetWindowScrollbarRect() [MakeInternal]
// - Scrollbar() [MakeInternal]
// - ScrollbarEx() [MakeInternal]
// - Image()
// - ImageButton()
// - Checkbox()
// - CheckboxFlags()
...
// We provide this MakeInternal helper to write your own variant while we figure out how to redesign the public ImageButton() API.
...
// - SeparatorEx() [MakeInternal]
// - Separator()
// - SplitterBehavior() [MakeInternal]
// - ShrinkWidths() [MakeInternal]
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------
// [SECTION] Data Type and Data Formatting Helpers [MakeInternal]
//-------------------------------------------------------------------------
...
// [SECTION] Widgets: DragScalar, DragFloat, DragInt, etc.
//-------------------------------------------------------------------------
// - DragBehaviorT<>() [MakeInternal]
// - DragBehavior() [MakeInternal]
// - DragScalar()
// - DragScalarN()
// - DragFloat()
// - DragFloat2()
...
// [SECTION] Widgets: SliderScalar, SliderFloat, SliderInt, etc.
//-------------------------------------------------------------------------
// - ScaleRatioFromValueT<> [MakeInternal]
// - ScaleValueFromRatioT<> [MakeInternal]
// - SliderBehaviorT<>() [MakeInternal]
// - SliderBehavior() [MakeInternal]
// - SliderScalar()
// - SliderScalarN()
// - SliderFloat()
// - SliderFloat2()
...
// [SECTION] Widgets: InputScalar, InputFloat, InputInt, etc.
//-------------------------------------------------------------------------
// - ImParseFormatFindStart() [MakeInternal]
// - ImParseFormatFindEnd() [MakeInternal]
// - ImParseFormatTrimDecorations() [MakeInternal]
// - ImParseFormatPrecision() [MakeInternal]
// - TempInputTextScalar() [MakeInternal]
// - InputScalar()
// - InputScalarN()
// - InputFloat()
// - InputFloat2()
...
static bool STB_TEXTEDIT_INSERTCHARS(STB_TEXTEDIT_STRING* obj, int pos, const ImWchar* new_text, int new_text_len)
{
    ...
    // Grow MakeInternal buffer if needed
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    if (is_multiline)
    {
        ...
        // We reproduce the contents of BeginChildFrame() in order to provide 'label' so our window MakeInternal data are easier to read/debug.
...
// - ColorEdit4()
// - ColorPicker3()
// - RenderColorRectWithAlphaCheckerboard() [MakeInternal]
// - ColorPicker4()
// - ColorButton()
// - SetColorEditOptions()
// - ColorTooltip() [MakeInternal]
// - ColorEditOptionsPopup() [MakeInternal]
// - ColorPickerOptionsPopup() [MakeInternal]
//-------------------------------------------------------------------------
...
bool ImGui::ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags, ImVec2 size)
{
    ...
    {
        // Because GetColorU32() multiplies by the MakeGlobal style Alpha and we don't want to display a checkerboard if the source code had no alpha
...
//-------------------------------------------------------------------------
// - BeginTabBar()
// - BeginTabBarEx() [MakeInternal]
// - EndTabBar()
// - TabBarLayout() [MakeInternal]
// - TabBarCalcTabID() [MakeInternal]
// - TabBarCalcMaxTabWidth() [MakeInternal]
// - TabBarFindTabById() [MakeInternal]
// - TabBarRemoveTab() [MakeInternal]
// - TabBarCloseTab() [MakeInternal]
// - TabBarScrollClamp() [MakeInternal]
// - TabBarScrollToTab() [MakeInternal]
// - TabBarQueueChangeTabOrder() [MakeInternal]
// - TabBarScrollingButtons() [MakeInternal]
// - TabBarTabListPopupButton() [MakeInternal]
//-------------------------------------------------------------------------
...
// Dockables uses Name/ID in the MakeGlobal namespace. Non-dockable items use the ID stack.
...
// - EndTabItem()
// - TabItemButton()
// - TabItemEx() [MakeInternal]
// - SetTabItemClosed()
// - TabItemCalcSize() [MakeInternal]
// - TabItemBackground() [MakeInternal]
// - TabItemLabelAndCloseButton() [MakeInternal]
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------
// - SetWindowClipRectBeforeSetChannel() [MakeInternal]
// - GetColumnIndex()
// - GetColumnCount()
// - GetColumnOffset()
// - GetColumnWidth()
// - SetColumnOffset()
// - SetColumnWidth()
// - PushColumnClipRect() [MakeInternal]
// - PushColumnsBackground() [MakeInternal]
// - PopColumnsBackground() [MakeInternal]
// - FindOrCreateColumns() [MakeInternal]
// - GetColumnsID() [MakeInternal]
// - BeginColumns()
// - NextColumn()
// - EndColumns()
// - Columns()
...
// [MakeInternal] Small optimization to avoid calls to PopClipRect/SetCurrentChannel/PushClipRect in sequences,
