...
// modifying imgui.h or imgui.cpp. You may include imgui_internal.h to access MakeInternal data structures, but it doesn't
...
/*
 ...
 - 2020/08/17 (1.78) - obsoleted use of the trailing 'float power=1.0f' parameter for DragFloat(), DragFloat2(), DragFloat3(), DragFloat4(), DragFloatRange2(), DragScalar(), DragScalarN(), SliderFloat(), SliderFloat2(), SliderFloat3(), SliderFloat4(), SliderScalar(), SliderScalarN(), VSliderFloat() and VSliderScalar().
                     ...
                     - obsoleted use of v_min > v_max in DragInt, DragFloat, DragScalar to lock edits (introduced in 1.73, was not demoed nor documented very), will be replaced by a more generic ReadOnly feature. You may use the ImGuiSliderFlags_ReadOnly MakeInternal flag in the meantime.
 ...
 - 2019/01/06 (1.67) - renamed io.InputCharacters[], marked MakeInternal as was always intended. Please don't access directly, and use AddInputCharacter() instead!
 ...
 - 2018/08/01 (1.63) - removed per-window ImGuiWindowFlags_ResizeFromAnySide beta flag in favor of a MakeGlobal io.ConfigResizeWindowsFromEdges [update 1.67 renamed to ConfigWindowsResizeFromEdges] to enable the feature.
 ...
 - 2018/02/07 (1.60) - reorganized context handling to be more explicit,
                       ...
                       - removed the default MakeGlobal context and font atlas instance, which were confusing for users of DLL reloading and users of multiple contexts.
 ...
 - 2015/01/11 (1.30) - removed GetDefaultFontData(). uses io.Fonts->GetTextureData*() API to retrieve uncompressed pixels.
                       ...
                       you now have more flexibility to load multiple TTF fonts and manage the texture buffer for MakeInternal needs. It is now recommended that you sample the font texture with bilinear interpolation.
...
#pragma clang diagnostic ignored "-Wglobal-constructors"            // warning: declaration requires a MakeGlobal destructor         // similar to above, not sure what the exact difference is.
...
// Otherwise, you probably don't want to modify them mid-program, and if you use MakeGlobal/static e.g. ImVector<> instances you may need to keep them accessible during program destruction.
...
{
    Alpha                   = 1.0f;             // MakeGlobal alpha applies to everything in ImGui
...
//-----------------------------------------------------------------------------
// [SECTION] RENDER HELPERS
// Some of those (MakeInternal) functions are currently quite a legacy mess - their signature and behavior will change,
...
// MakeInternal ImGui functions to render text
...
// Free up/compact MakeInternal window buffers, we can use this when a window becomes unused.
...
// This is roughly matching the behavior of MakeInternal-facing ItemHoverable()
...
// MakeInternal facing ItemHoverable() used when submitting widgets. Differs slightly from IsItemHovered().
...
// MakeInternal state access - if you want to share Dear ImGui state between modules (e.g. DLL) or allocate it yourself
...
// [MakeInternal] This doesn't test if the button is pressed
...
// - GetContentRegionMax()
// - GetContentRegionMaxAbs() [MakeInternal]
...
// [MakeInternal] Calculate full item size given user provided 'size' parameter and default width/height. Default width is often == CalcItemWidth().
...
// [MakeInternal] Absolute coordinate. Saner. This is not exposed until we finishing refactoring work rect features.
...
// MakeInternal version that takes a position to decide on newline placement and pad items according to their depth.
...
// [SECTION] SETTINGS
//-----------------------------------------------------------------------------
// - UpdateSettings() [MakeInternal]
// - MarkIniSettingsDirty() [MakeInternal]
// - CreateNewWindowSettings() [MakeInternal]
// - FindWindowSettings() [MakeInternal]
// - FindOrCreateWindowSettings() [MakeInternal]
// - FindSettingsHandler() [MakeInternal]
// - ClearIniSettings() [MakeInternal]
// - LoadIniSettingsFromDisk()
// - LoadIniSettingsFromMemory()
// - SaveIniSettingsToDisk()
// - SaveIniSettingsToMemory()
// - WindowSettingsHandler_***() [MakeInternal]
//-----------------------------------------------------------------------------
...
void ImGui::ShowMetricsWindow(bool* p_open)
{
    ...
    // Misc Details
    if (ImGui::TreeNode("MakeInternal state"))
    {
